...
#define CMC310_157		0x102D2FA0
#define CM310_236		0x102D44A0
#define CM310_392		0x102DBF20
#define CX300_1045		0x102dc140
#define CMC310_392		0x102DC6B0
#define CM310_0			0x102e5cd0
#define CX300_1503		0x102e8ab0
#define CX300_0			0x102ec500
...
#define CX320_776		0x1032DE40
#define CXC320_776		0x1032E5E0
#define CX320_1030		0x103392C0
#define CXC320_1030		0x10339C10
#define CM320_1212		0x1033C360
#define CM320_1219		0x1033C410
#define CMC320_1212		0x1033CCB0
#define CMC320_1219		0x1033CD60
#define CX320_1180		0x10340710
#define CX320_1212		0x10340F30
#define CX320_1219		0x10340FE0
#define CXC320_1180		0x10341050
...
#define CXC330_218		0x10346E20
#define CX360_5XX		0x10375620
#define CXC360_427		0x103759A0
#define CXC360_521		0x103760B0
...
*/
#define NBOOT_CM310_0			0x100a2af8
#define NBOOT_CX300_1045		0x100a2c90
#define NBOOT_CMC310_157		0x100a2e50
#define NBOOT_CX300_1503		0x100a40b4
#define NBOOT_CM310_236			0x100a427c
#define NBOOT_CX300_0			0x100a4280
#define NBOOT_CM310_392			0x100a4488
#define NBOOT_CMC310_392		0x100a4770
...
#define NBOOT_CM320_121X		0x100afc20
#define NBOOT_CMC320_121X		0x100afefc
...
#define NBOOT_CXC330_218		0x100b7f2c
#define NBOOT_CXC391_38			0x100bf304
#define NBOOT_CXC360_427		0x100bf358
...
#define NBOOT_CXC360_521		0x100bfc7c
...
*/
#define BOOT2UPD_CM310_392		0x100A2BCC
#define BOOT2UPD_CMC310_392		0x100A2EB4
#define BOOT2UPD_CX310_392		0x100A6178
#define BOOT2UPD_CXC310_392		0x100A6460
#define BOOT2UPD_CXC391_38		0x100BD88C
#define BOOT2UPD_CXC360_427		0x100BD910
...
#define BOOT2UPD_CXC360_521		0x100BE234
...
#define BOOT2UPD_CXC452_8		0x100C9EC8
#define BOOT2UPD_CX451_X		0x100C9FDC
#define BOOT2UPD_CX452_8		0x100C9FE0
...
#define SELFD_CX452_8			0x10158DDC
#define SELFD_CXC452_8			0x1015911C
...
#define ASIC1_CXC360_427		0x100BFA91
...
#define ASIC1_CXC360_521		0x100C03B5
...
#define ASIC1_CXC452_8			0x100CC125
#define ASIC1_CX451_X			0x100CC239
#define ASIC1_CX452_8			0x100CC23D
...
#define STAT_CM310_392			0x10368C70
#define STAT_CMC310_392			0x10369400
...
#define MALLOC_CM310_392		0x1035B584
#define MALLOC_CMC310_392		0x1035BD14
...
#define FREAD_CM310_392			0x10360E50
#define FREAD_CMC310_392		0x103615E0
...
#define FCLOSE_CM310_392		0x10360520
#define FCLOSE_CMC310_392		0x10360CB0
