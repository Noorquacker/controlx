/*
 * taken and adapted from nLaunchy
 *
...
{CX300_0,			0b00,	IGNORE,						NBOOT_CX300_0,			IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CX300_1045,		0b00,	IGNORE,						NBOOT_CX300_1045,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CX300_1503,		0b00,	IGNORE,						NBOOT_CX300_1503,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
...
{CM310_0,			0b10,	IGNORE,						NBOOT_CM310_0,			IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CMC310_157,		0b11,	IGNORE,						NBOOT_CMC310_157,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CM310_236,			0b10,	IGNORE,						NBOOT_CM310_236,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
...
{CM310_392,			0b10,	BOOT2UPD_CM310_392,			NBOOT_CM310_392,		IGNORE,						IGNORE,					IGNORE,					FOPEN_CM310_392,		STAT_CM310_392,			MALLOC_CM310_392,		FREAD_CM310_392,		FCLOSE_CM310_392,		},
{CMC310_392,		0b11,	BOOT2UPD_CMC310_392,		NBOOT_CMC310_392,		IGNORE,						IGNORE,					IGNORE,					FOPEN_CMC310_392,		STAT_CMC310_392,		MALLOC_CMC310_392,		FREAD_CMC310_392,		FCLOSE_CMC310_392,		},
{CX320_776,			0b00,	IGNORE,						NBOOT_CX320_776,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CXC320_776,		0b01,	IGNORE,						NBOOT_CXC320_776,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CX320_1030,		0b00,	IGNORE,						NBOOT_CX320_1030,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CXC320_1030,		0b01,	IGNORE,						NBOOT_CXC320_1030,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CX320_1180,		0b00,	IGNORE,						NBOOT_CX320_1180,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CXC320_1180,		0b01,	IGNORE,						NBOOT_CXC320_1180,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
...
{CM320_1212,		0b10,	IGNORE,						NBOOT_CM320_121X,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CMC320_1212,		0b11,	IGNORE,						NBOOT_CMC320_121X,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
...
{CM320_1219,		0b10,	IGNORE,						NBOOT_CM320_121X,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CMC320_1219,		0b11,	IGNORE,						NBOOT_CMC320_121X,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
...
{CXC330_218,		0b01,	IGNORE,						NBOOT_CXC330_218,		IGNORE,						IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					}, 														
...
{CXC360_427,		0b01,	BOOT2UPD_CXC360_427,		NBOOT_CXC360_427,		SELFD_CXC360_427,			ASIC1_CXC360_427,		IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},
{CXC360_521,		0b01,	BOOT2UPD_CXC360_521,		NBOOT_CXC360_521,		SELFD_CXC360_521,			ASIC1_CXC360_521,		IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},														
...
{CX452_8,			0b00,	BOOT2UPD_CX452_8,			IGNORE,					SELFD_CX452_8,				ASIC1_CX452_8,			ASIC2_CX452_8,			IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},	
{CXC452_8,			0b01,	BOOT2UPD_CXC452_8,			IGNORE,					SELFD_CXC452_8,				ASIC1_CXC452_8,			ASIC2_CXC452_8,			IGNORE,					IGNORE,					IGNORE,					IGNORE,					IGNORE,					},	
};

uint8_t getOSIndex(uint32_t os_id, uint32_t base) {
	uint8_t i=0;
	for(i=0;i<NOS;i++) {
	...
	if(os_ind<NOS) {
		if(os_patches[os_ind][I_BOOT2UPD]) {
			if(os_patches[os_ind][I_SYSCALLS]) {
				memcpy(ndless_loader+OFFSET_MODEL, &(os_patches[os_ind][I_SYSCALLS]), NSYSCALLS*sizeof(uint32_t));
				memcpy(base+(os_patches[os_ind][I_BOOT2UPD]&~0x10000000),ndless_loader,sizeof(ndless_loader));
			}
			else
